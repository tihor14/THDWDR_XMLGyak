...
public class JSONWrite {
	 public static void main(String[] args) {
         ...
         try (Reader reader = new FileReader("kurzusfelvetelTHDWDR.json")) {
            ...
            JSONObject.put("orarendTHDWDR", oraObject);

            FileWriter file = new FileWriter("kurzusfelvetelTHDWDR.json");
